      ...
      btnInsUpd.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            if (statusText.equals("입력")) {
               ...
               if (result == -1) {
                  JOptionPane.showMessageDialog(contentPane, "ER3:데이터를 입력할 수 없습니다.\n", "오류", JOptionPane.ERROR_MESSAGE);
               } else if (result == 0) {
               ...
               if (status == 2) {
                  ...
                  if (result == -1) {
                     JOptionPane.showMessageDialog(contentPane, "ER5:데이터를 수정할 수 없습니다.\n", "오류",
                           JOptionPane.ERROR_MESSAGE);
                  } else if (result == 0) {
                     JOptionPane.showMessageDialog(contentPane, "ER6:데이터를 수정할 수 없습니다.\n이미 존재하는 데이터일 수 있습니다.",
                           "오류", JOptionPane.ERROR_MESSAGE);
                  } else {
                     JOptionPane.showMessageDialog(contentPane, "데이터 수정이 완료되었습니다.", "완료",
            ...
            if (statusText.equals("삭제")) {
               ...
               if (check == JOptionPane.YES_OPTION) {
                  ...
                  if (result == -1) {
                     ...
                     JOptionPane.showMessageDialog(contentPane, "데이터 삭제가 완료되었습니다.", "완료",
                           JOptionPane.INFORMATION_MESSAGE);
                     main.placeTable.setModel(main.setPlaceTable(null));
                     util.hiddenTableColumn(main.placeTable, 0);
                     dispose();
